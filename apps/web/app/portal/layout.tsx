...
export default function PortalLayout({
  ...
  const navigation = [
    { name: "Início", href: "/portal", icon: HomeIcon },
    { name: "Meus Dados", href: "/portal/meus-dados", icon: UserIcon },
    { name: "Obrigações", href: "/portal/obrigacoes", icon: DocumentIcon },
    { name: "Financeiro", href: "/portal/financeiro", icon: CurrencyIcon },
    { name: "Solicitações", href: "/portal/solicitacoes", icon: MessageIcon },
  ];
    ...
    <div className="flex h-screen bg-background">
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-divider px-6">
          <h2 className="text-xl font-bold">Portal do Cliente</h2>
        </div>
            ...
            <Dropdown placement="bottom-end">
              ...
              <DropdownMenu aria-label="Profile Actions">
                <DropdownItem key="profile" className="gap-2">
                  ...
                  <p className="text-sm">cliente@example.com</p>
                </DropdownItem>
