...
const financialReports = [
  ...
  },
  {
    ...
    highlight: true,
    features: [
      'Saldo acumulado por movimento',
      'Filtro por cliente ou escritório',
      'Ideal para conciliação diária',
    ],
  },
  {
...
export function RelatoriosModule() {
  ...
  const handleGenerateWithRange = async () => {
    ...
    if (isAdminOrFunc) {
      if (isOfficeReport) {
        if (!OFFICE_CLIENT_ID) {
          toast.error(
            'Configure o ID do escritório (NEXT_PUBLIC_OFFICE_CLIENT_ID) para gerar relatório do escritório.'
          );
          setIsGeneratingId(null);
          return;
        }
  ...
  const getColorClasses = (color: string) => {
    const colorMap: Record<string, string> = {
      ...
      primary:
        'bg-gradient-to-br from-primary-50 to-blue-50 dark:from-primary-950/30 dark:to-blue-950/20 border-primary-200/60 dark:border-primary-800/40',
      slate:
        'bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-900/40 dark:to-gray-900/30 border-slate-200/60 dark:border-slate-700/40',
      green:
        'bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-950/30 dark:to-green-950/20 border-emerald-200/60 dark:border-emerald-800/40',
      amber:
        'bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-950/30 dark:to-yellow-950/20 border-amber-200/60 dark:border-amber-800/40',
      purple:
        'bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/30 dark:to-violet-950/20 border-purple-200/60 dark:border-purple-800/40',
                  ...
                  >
                    ...
                    <CardHeader className="pb-2">
                      <div className="flex items-start gap-3 w-full">
                        {/* Ícone com fundo */}
                        <div
                          className={`p-2.5 rounded-lg ${iconBgClasses} transition-transform duration-300 group-hover:scale-110`}
                        >
                ...
                <CardBody className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-3 rounded-lg bg-background/50 dark:bg-background/20 border border-default-200 dark:border-default-700/30">
                    ...
                    <p className="text-sm text-default-600 dark:text-default-400">
                      Mostra o lucro ou prejuízo do período através da fórmula: Receita total –
                  ...
                  <div className="p-3 rounded-lg bg-background/50 dark:bg-background/20 border border-default-200 dark:border-default-700/30">
                    ...
                    <p className="text-sm text-default-600 dark:text-default-400">
                      Visualize entradas e saídas de dinheiro mês a mês para prever necessidades de
                      capital
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-background/50 dark:bg-background/20 border border-default-200 dark:border-default-700/30">
                    ...
                    <p className="text-sm text-default-600 dark:text-default-400">
                      Registro completo de todas as movimentações financeiras, ideal para controle
                      diário e conciliação bancária
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-background/50 dark:bg-background/20 border border-default-200 dark:border-default-700/30">
                    ...
                    <p className="text-sm text-default-600 dark:text-default-400">
                      Identifique seus clientes mais rentáveis através da análise de receita gerada
                      por cada um
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-background/50 dark:bg-background/20 border border-default-200 dark:border-default-700/30">
                    ...
                    <p className="text-sm text-default-600 dark:text-default-400">
                      Controle de custos através da classificação de despesas em grupos como folha,
                      marketing, aluguel, etc.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-background/50 dark:bg-background/20 border border-default-200 dark:border-default-700/30">
                    ...
                    <p className="text-sm text-default-600 dark:text-default-400">
                      Planejamento financeiro através da previsão de entradas e saídas futuras
                  ...
                  <div className="p-3 rounded-lg bg-background/50 dark:bg-background/20 border border-default-200 dark:border-default-700/30 md:col-span-2">
                    ...
                    <p className="text-sm text-default-600 dark:text-default-400">
                      Métricas essenciais: margem de lucro, percentual de despesas fixas sobre
                      receita e índice de inadimplência
                    </p>
                  </div>
                </CardBody>
              </Card>
        ...
        <ModalContent>
          ...
          <ModalBody className="space-y-4">
            ...
            >
              ...
              <SelectItem key={ReportFormat.XLS}>XLS</SelectItem>
            </Select>
            {isAdminOrFunc && (
          ...
          <ModalFooter>
            ...
            <Button
              color="primary"
              onPress={handleGenerateWithRange}
              isLoading={Boolean(isGeneratingId)}
            >
              Gerar
            </Button>
          </ModalFooter>
