  ...
  return (
    <Card className="border border-default-200 dark:border-default-800/40">
      <CardBody className="p-0">
        <div className="flex items-center justify-between p-4 border-b border-default-200 dark:border-default-800/40">
          <div>
          ...
          <Button size="sm" variant="flat" onPress={handleRefresh} isLoading={isRefreshing}>
            Atualizar
          </Button>
        </div>
        ...
        >
          <Tab key="ativos" title={`Ativos (${activeHistory?.total ?? 0})`} className="pb-4">
            {activeItems.length === 0 ? (
              ...
              <Table aria-label="Relatórios gerados para download" removeWrapper>
                <TableHeader>
          ...
          <Tab key="excluidos" title={`Excluídos (${deletedHistory?.total ?? 0})`} className="pb-4">
            {deletedItems.length === 0 ? (
              ...
              <Table aria-label="Histórico de relatórios excluídos" removeWrapper>
                <TableHeader>
                  <TableColumn>Título</TableColumn>
                  <TableColumn>Formato</TableColumn>
                  <TableColumn>Período</TableColumn>
