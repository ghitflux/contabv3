...
import { Calendar, GripVertical, LayoutGrid, User } from "lucide-react"
  ...
  const columns = [
    {
      ...
      title: "A Fazer",
      color: "bg-gradient-to-br from-slate-100 to-slate-50 dark:from-slate-800/30 dark:to-slate-900/20",
    ...
    },
    {
      ...
      title: "Revisão",
      color: "bg-gradient-to-br from-amber-100 to-amber-50 dark:from-amber-900/30 dark:to-amber-950/20",
    ...
    },
    {
      ...
      title: "Concluído",
      color: "bg-gradient-to-br from-emerald-100 to-emerald-50 dark:from-emerald-900/30 dark:to-emerald-950/20",
              ...
              >
                <div className="px-4 pt-4 pb-2">
                  <div className="flex items-center justify-between w-full">
                    ...
                    <span className={`inline-flex items-center justify-center min-w-7 h-7 px-2 rounded-full bg-white/60 dark:bg-black/20 ${column.headerColor} text-xs font-bold shadow-sm`}>
                        ...
                        <CardBody className="p-4 space-y-3">
                          <div className="flex items-start justify-between gap-2">
                            <div className="flex items-start gap-2">
                              <GripVertical className="h-4 w-4 text-default-300 mt-0.5" />
